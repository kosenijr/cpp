...
int main()
{
    ...
    if (friend_sex = string{"m"}) cout << "How is he doing? If you see him again, please let him know that I asked of him. \n";
    if (friend_sex = string{"f"}) cout << "How is she doing? If you see her again, please let him know that I asked of him. \n";
}
