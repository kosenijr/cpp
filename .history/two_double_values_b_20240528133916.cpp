...
int main()
{
    ...
    // std::cout << "This is the type: " << typeid(extract_str1).name() << "\n";
    // std::cout << "This is number of characters: " << extract_str1.size() << "\n";
    // std::cout << "This is the string: " << extract_str2 << "\n";
    // std::cout << "This is the type: " << typeid(extract_str2).name() << "\n";
    ...
    // ratio
    cout << "The ratio: " << val1_int << ":" << val2_int << "\n";
