...
int main()
{
    ...
    int penny, pennies, total_of_pennies, nickel, nickels, total_of_nickels, dime, dimes, total_of_dimes, quarter, quarters, total_of_quarters, half_dollar, half_dollars, total_of_half_dollars, dollar_coin, dollar_coins, total_of_dollar_coins, total_of_coins;
    double total_in_dollars;
