...
int main()
{
    ...
    {
        cout
            << "The smaller number: " << val1_int << "\n"
            << "The larger number: " << val2_int << "\n"
            << "The sum: " << val1_int + val2_int << "\n"
            << "The difference: " << val2_int - val1_int << "\n"
            << "The product: " << val1_int * val2_int << "\n";
    }
    else
    {
        cout
            << "The smaller number: " << val2_int << "\n"
            << "The larger number: " << val1_int << "\n"
            << "The sum: " << val1_int + val2_int << "\n"
            << "The difference: " << val1_int - val2_int << "\n"
            << "The product: " << val1_int * val2_int << "\n";
    };
