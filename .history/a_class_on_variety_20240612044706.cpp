...
public:
    ...
    Variety(int a, double b, string c, char d, float e, bool f, const g)
    {
    ...
    int main()
    {
        ...
        Variety obj_of_vars(8, 9.34586, "Muni Long", 'a', 8.4568, true, "Made for me");
        cout 
