...
int main()
{
    ...
    cout << friend_sex << "\n";
    if (friend_sex == "m") {cout << "How is he doing? If you see " << friend_name << " again, please let him know that I asked of him. \n"}
    if (friend_sex == "f") {cout << "How is she doing? If you see " << friend_name << " again, please let him know that I asked of him. \n"}
}
