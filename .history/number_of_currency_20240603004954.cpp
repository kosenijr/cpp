...
int main()
{
    ...
    int nickel, nickels, dime, dimes, quarter, quarters, half_dollar, half_dollars, dollar_coin, dollar_coins, total_of_coins, total_in_dollars;
    double penny, pennies, total_of_pennies, total_of_nickels, total_of_dimes, total_of_quarters, total_of_half_dollars, total_of_dollar_coins, total_in_cents;
