...
int main()
{
    ...
    double total_of_pennies, total_of_nickels, total_of_dimes, total_of_quarters, total_of_half_dollars, total_of_dollar_coins, total_in_cents, total_of_coins, total_in_dollars;
    ...
    cout << "The value of your coins is " << total_of_coins << " cents. \n";

    // provide total amount in dollars to standard output stream
    total_in_dollars = total_of_coins / 100;

    // provide amount in dollars
    cout << "The value of your coins in dollars is $" << fixed << std::setprecision(2) << total_in_dollars << ". \n";
