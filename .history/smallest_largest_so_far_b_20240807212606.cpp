...
int main()
{
    ...
    char char1;
    double dbl1, smallest_so_far = 0, largest_so_far = 0;
    ...
    while (true)
    {
        ...
        if (cin >> dbl1)
        {
            if ((dbl1 > 0 && smallest_so_far == 0 && largest_so_far == 0) || (dbl1 > largest_so_far) || (dbl1 == largest_so_far))
            {
                largest_so_far = dbl1;
            }
            else if ((dbl1 > 0 && dbl1 < largest_so_far && smallest_so_far == 0) || (dbl1 >= 0 && dbl1 < smallest_so_far) || (dbl1 > smallest_so_far && dbl1 < largest_so_far) || (dbl1 == 0 && smallest_so_far == 0) || (dbl1 == smallest_so_far))
            {
