...
int main()
{
   ...
   double amount_input = 0.00;
    ...
    // rate
    constexpr double conversion_rate = get_conversion_rate(currency);
    // conditionals
    ...
    {
        cout << "The selected amount of " << amount_input << " " << selected_unit << " is " << fixed << setprecision(2) << amount_input / conversion_rate << " dollars. \n";
    }
}